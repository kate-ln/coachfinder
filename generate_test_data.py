...
def generate_test_data():
    ...
    # Data sizes
    user_count = 1000
    thread_count = 10**5  # 100,000 threads
    message_count = 10**6  # 1,000,000 messages
...
def generate_larger_test_data():
    """Generate even larger test data for stress testing"""
    ...
    # Larger data sizes
    user_count = 1000
    thread_count = 10**6  # 1,000,000 threads
    message_count = 10**7  # 10,000,000 messages
    ...
    total_time = user_time + thread_time + message_time
    print(f"\nLARGE test data generation completed in {total_time:.2f} seconds")
    print("Generated:")
    print(f"- {user_count} users")
    print(f"- {thread_count} threads")
    print(f"- {message_count} messages")
