...
def add_indexes():
    ...
    db.execute("CREATE INDEX IF NOT EXISTS idx_announcements_student_user_id ON announcements_student (user_id)")
    
    # Add index for announcements_coach.user_id
    print("Adding index on announcements_coach.user_id...")
    db.execute("CREATE INDEX IF NOT EXISTS idx_announcements_coach_user_id ON announcements_coach (user_id)")
    
    # Add index for announcements_student.found
    print("Adding index on announcements_student.found...")
    db.execute("CREATE INDEX IF NOT EXISTS idx_announcements_student_found ON announcements_student (found)")
    
    # Add index for announcements_coach.found
    print("Adding index on announcements_coach.found...")
    db.execute("CREATE INDEX IF NOT EXISTS idx_announcements_coach_found ON announcements_coach (found)")
